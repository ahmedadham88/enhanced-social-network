...
gadgets.util.getUrlParameters=function(){return{st:"authtoken",url:"http://www.gadget.com/gadget.xml"}
};
...
gadgets.config.init({"core.io":{proxyUrl:"http://www.example.com/proxy?url=%url%&refresh=%refresh%",jsonProxyUrl:"http://www.example.com/json"}});
...
this.assertEquals("http://www.example.com/proxy?url=http%3a%2f%2ftarget.example.com%2fimage.gif&refresh=3600",A)
};
...
this.assertEquals("http://www.example.com/proxy?url=http%3a%2f%2ftarget.example.com%2fimage.gif&refresh=30",A)
};
...
this.assertEquals("http://www.example.com/proxy?url=http%3a%2f%2ftarget.example.com%2fimage.gif&refresh=0",A)
};
...
IoTest.prototype.testNoMethod=function(){var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
...
IoTest.prototype.testNoMethod_nonDefaultRefresh=function(){var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
this.setStandardArgs(A,false);
A.setQueryArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testNoMethod_disableRefresh=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
...
IoTest.prototype.testRepeatGet=function(){var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
this.setStandardArgs(A,false);
A.setQueryArg("url","http://target.example.com/somepage");
var B=this.makeFakeResponse("{ 'http://target.example.com/somepage' : { 'body' : 'some data' }}");
this.fakeXhrs.expect(A,B);
...
IoTest.prototype.testPost=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
...
IoTest.prototype.testPost_noBody=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("httpMethod","POST");
...
IoTest.prototype.testPost_emptyBody=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("httpMethod","POST");
A.setBodyArg("postData","");
A.setBodyArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testPut=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
...
IoTest.prototype.testPut_noBody=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("httpMethod","PUT");
A.setBodyArg("postData","");
A.setBodyArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testSignedGet=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testSignedPost=function(){var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("url","http://target.example.com/somepage");
A.setBodyArg("signOwner","true");
A.setBodyArg("signViewer","true");
...
var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testJson=function(){var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
this.setStandardArgs(A,false);
A.setQueryArg("url","http://target.example.com/somepage");
...
IoTest.prototype.testJson_malformed=function(){var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
this.setStandardArgs(A,false);
A.setQueryArg("url","http://target.example.com/somepage");
A.setQueryArg("contentType","JSON");
...
IoTest.prototype.testPreload=function(){gadgets.io.preloaded_={"http://target.example.com/somepage":{rc:200,body:"preloadedbody",}};
var B=null;
gadgets.io.makeRequest("http://target.example.com/somepage",function(C){B=C
});
this.assertEquals("preloadedbody",B.text);
var A=new fakeXhr.Expectation("GET","http://www.example.com/json");
this.setStandardArgs(A,false);
A.setQueryArg("url","http://target.example.com/somepage");
...
gadgets.io.preloaded_={"http://target.example.com/somepage":{rc:200,oauthState:"stateinfo",oauthApprovalUrl:"http://www.example.com/approve",}};
var A=new fakeXhr.Expectation("POST","http://www.example.com/json");
this.setStandardArgs(A,true);
A.setBodyArg("url","http://target.example.com/somepage");
A.setBodyArg("authz","oauth");
...
this.assertEquals("http://www.example.com/approve",C.oauthApprovalUrl);
gadgets.io.makeRequest("http://target.example.com/somepage",function(D){C=D
},B);
