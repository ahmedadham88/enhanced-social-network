...
RestfulContainer.prototype.requestCreateActivity=function(D,B,A){A=A||{};
...
RestfulContainer.prototype.requestData=function(E,I){I=I||{};
...
var B=this;
return new RestfulRequestItem(A.url,A.method,null,function(E){return B.createPersonFromJson(E)
})
};
