...
public class SelectStateValidator implements Validator{
	/** Invalid selection for the menu*/
	private static final String selectState = "Choose a State";

	/** Validator id for SelectMenutValidator */
	private String validatorMessageId = "validate_select_state";
