...
public class SysException extends AbstractBaseException {
	/** Constructor for SysException with the errorcode */
	public SysException(String errorCode) {
		super(errorCode);
	}

	/** Constructor for SysException with the errorcode and user-defined message */
	public SysException(String errorCode, String message) {
		super(errorCode, message);
	}

	/** Constructor for SysException with the errorcode and the throwable object */
	public SysException(String errorCode, Throwable cause) {
		super(errorCode, cause);
	}

	/**
	 * Constructor for SysException with the errorcode, user-defined message and
