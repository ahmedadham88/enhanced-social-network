		...
		// TODO Auto-generated method stub
		  ...
		  try {
		   ...
		   ConnectionParty dest = new ConnectionParty(
		     "sip:charlie@openepc.test", "192.168.3.132", 23005);
//		   ServiceInfo serviceInfo = new ServiceInfo("Webcamstream", 1000,
//		     400, MediaType.VIDEO, 40);
		   
		   ServiceInfo serviceInfo = new ServiceInfo("www.youtube.com", 40000,
				     40000, MediaType.DATA, 40);
		   
		   serviceInfo.setPriority(3);
		   Session newSession = new Session("YouTube", dest, source,
		     serviceInfo);
